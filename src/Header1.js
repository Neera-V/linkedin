...
import { joinnow } from "./features/joinSlice";
    ...
    <div>
      <nav className="header1">
        ...
        <div className="header1_right">
          <div className="header2_icon">
            <HeaderOption1 Icon={Discover} title="Discover" />
            <HeaderOption1 Icon={People} title="People" />
            <HeaderOption1 Icon={Learning} title="Learning" />
            <HeaderOption1 Icon={Jobs} title="Jobs" />
            <hr className="horizontal_line" />
          </div>

          <div className="logged1">
            <a className="header_join1" onClick={joiNow}>
              Join now
            </a>
            <a className="header_signin1" href="">
              Sign in
            </a>
          </div>
        </div>
